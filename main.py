...
if __name__ == '__main__':
    ...
    while True:
        ...
        if tanya in ("c", "C"):            # melakukan perulangan hingga user memilih n maka perulangan akan berhenti
            while True:
                no += 1
            ...
            # menampilkan data dalam bentuk table menggunakan package tabulatte
        ...
        # jika tanya == Q maka keluar dari peogram 
        elif tanya in ("q", "Q"):
            print("")
